 ...
 */
UCLASS()
class OBJECTL_API UMyObject : public UObject
{
	GENERATED_BODY()
public:
...
protected:
	...
	UPROPERTY(EditAnywhere, Category = ObjectLibrary)
		TMap<FString,UObject*>	Mapobj;
	UPROPERTY(EditAnywhere, Category = ObjectLibrary)
		TMap<FString, FString>	Mapstr;
	UPROPERTY(EditAnywhere, Category = ObjectLibrary)
		TMap<FString, FVector>	Mapvec;
	UPROPERTY(EditAnywhere, Category = ObjectLibrary)
		TMap<FString, float>	Mapfloat;
...
public:
	 ...
	 */
	static class UMyObject* CreateLibrary(UClass* InBaseClass, bool bInHasBlueprintClasses, bool bInUseWeak);
